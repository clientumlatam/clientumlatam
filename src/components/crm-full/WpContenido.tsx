...
const TIPOS: { id: TipoContenido; label: string; icon: React.ReactNode; desc: string; placeholder: string }[] = [
  ...
  { id: 'social', label: 'Post Redes Sociales', icon: <Share2 className="w-4 h-4" />, desc: 'Instagram · Facebook · LinkedIn', placeholder: 'Ej: Promoción 20% off en servicio CRM este mes' },
];
